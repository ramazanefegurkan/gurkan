...
- [x] **T01: Scaffold ASP.NET Core project, entities, DbContext and seed migration** `est:1h`
...
- [x] **T02: Implement auth services and AuthController (login, register, refresh, change-password)** `est:1h`
...
- [x] **T03: Implement GroupsController, UsersController and group-based access control** `est:1h`
...
- [x] **T04: Integration tests proving auth + group access control contract** `est:1h`
