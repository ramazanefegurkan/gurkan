...
public class CustomWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    public async Task ResetDatabaseAsync()
    {
        ...
        await db.Database.ExecuteSqlRawAsync("""
            TRUNCATE TABLE "BankTransactions", "CreditCardStatements", "CreditCardSpendings", "CreditCards", "BankAccounts", "TelegramUserLinks", "DeviceTokens", "RentIncreases", "RentPayments", "ShortTermRentals", "Expenses", "Bills", "Documents", "Tenants", "PropertyNotes", "RefreshTokens", "GroupMembers", "Properties", "Groups", "Users" CASCADE;
        """);
