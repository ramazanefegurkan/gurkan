        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CreditCards_Groups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CreditCardSpendings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CreditCardSpendings_CreditCards_CreditCardId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaidFromBankAccountId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now() at time zone 'utc'")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CreditCardStatements_BankAccounts_PaidFromBankAccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    Date = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    RelatedStatementId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now() at time zone 'utc'")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BankTransactions_CreditCardStatements_RelatedStatementId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankTransactions_RelatedStatementId",
                table: "BankTransactions",
                column: "RelatedStatementId");

            migrationBuilder.CreateIndex(
                name: "IX_CreditCards_GroupId",
                table: "CreditCards",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_CreditCardSpendings_CreditCardId",
                table: "CreditCardSpendings",
                column: "CreditCardId");

            migrationBuilder.CreateIndex(
                name: "IX_CreditCardStatements_CreditCardId_StatementDate",
                table: "CreditCardStatements",
                columns: new[] { "CreditCardId", "StatementDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CreditCardStatements_PaidFromBankAccountId",
                table: "CreditCardStatements",
